...
DEV_OP = [
    [
        InlineKeyboardButton(text=" ᴏᴡɴᴇʀ 🥀", url=f"https://t.me/Villlaaiinnn"),
        InlineKeyboardButton(text=" ꜱᴜᴘᴘᴏʀᴛ ✨", url=f"https://t.me/Ishq_Sukoon"),
    ],
    [
...
MUSIC_BACK_BTN = [
    [
        InlineKeyboardButton(text=" ᴍᴜsɪᴄ 🎵 ", url=f"https://t.me/EvaMusiXBot"),
    ],
]
